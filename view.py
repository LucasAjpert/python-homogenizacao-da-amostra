...
class MainMenu(Frame):
    def __init__(self, parent, controller, view):
        ...
        self.tree.heading("padrao_construtivo", text="Padrão Construtivo")
        self.tree.heading("valor_residual", text="Valor Residual")
...
class CadastroUrbano(Frame):
    def __init__(self, parent, controller, view):
        ...
        # --- CORREÇÃO AQUI: FRENTES MÚLTIPLAS RESTAURADO ---
...
# --- ALTERAÇÕES NA TREEVIEW ---
        ...
        colunas_ids = [c[0] for c in colunas_info]
...
# (O restante do arquivo view.py permanece o mesmo)
# ...
